...
void processCommand(byte type, byte value)
{
    ...
    if (lowBattery && type != 0x01) { // Allow stop command even on low battery
...
void loadCalibration()
{
    ...
    Serial.print("Trims: ");
    Serial.print(trim0); Serial.print(", ");
    Serial.print(trim1); Serial.print(", ");
    Serial.print(trim2); Serial.print(", ");
    Serial.print(trim3); Serial.print(", ");
    Serial.print(trim4); Serial.print(", ");
    Serial.print(trim5); Serial.print(", ");
    Serial.print(trim6); Serial.print(", ");
